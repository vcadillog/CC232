...
PriorityQueue huffmanMakeForest(const std::vector<HuffmanSymbol> &alphabet) {
  ...
  if (pq.empty()) {
    throw std::invalid_argument(
        "Huffman requiere simbolos con frecuencia positiva");
  }
  return pq;
}
...
huffmanGenerateTreeFromForest(PriorityQueue forest) {
  while (forest.size() > 1) {
...
template <class PriorityQueue>
std::vector<HuffmanBuildStep>
huffmanBuildTraceWith(const std::vector<HuffmanSymbol> &alphabet) {
...
template <class PriorityQueue>
std::shared_ptr<HuffmanNode>
huffmanGenerateTreeWith(const std::vector<HuffmanSymbol> &alphabet) {
  return huffmanGenerateTreeFromForest(
      huffmanMakeForest<PriorityQueue>(alphabet));
}

inline std::shared_ptr<HuffmanNode>
huffmanGenerateTree(const std::vector<HuffmanSymbol> &alphabet) {
  using PQType =
      PQ_ComplHeap<std::shared_ptr<HuffmanNode>, HuffmanLowerFrequencyFirst>;
  return huffmanGenerateTreeWith<PQType>(alphabet);
}

inline std::shared_ptr<HuffmanNode>
huffmanGenerateTreeLeftHeap(const std::vector<HuffmanSymbol> &alphabet) {
  using PQType =
      PQ_LeftHeap<std::shared_ptr<HuffmanNode>, HuffmanLowerFrequencyFirst>;
  return huffmanGenerateTreeWith<PQType>(alphabet);
}

inline std::vector<HuffmanBuildStep>
huffmanBuildTrace(const std::vector<HuffmanSymbol> &alphabet) {
  using PQType =
      PQ_ComplHeap<std::shared_ptr<HuffmanNode>, HuffmanLowerFrequencyFirst>;
...
inline std::vector<HuffmanBuildStep>
huffmanBuildTraceLeftHeap(const std::vector<HuffmanSymbol> &alphabet) {
  using PQType =
      PQ_LeftHeap<std::shared_ptr<HuffmanNode>, HuffmanLowerFrequencyFirst>;
  return huffmanBuildTraceWith<PQType>(alphabet);
}
...
huffmanGenerateCodesWith(const std::vector<HuffmanSymbol> &alphabet) {
  std::unordered_map<char, std::string> codes;
  huffmanCollectCodes(huffmanGenerateTreeWith<PriorityQueue>(alphabet), "",
                      codes);
  return codes;
}

inline std::unordered_map<char, std::string>
huffmanGenerateCodes(const std::vector<HuffmanSymbol> &alphabet) {
  using PQType =
      PQ_ComplHeap<std::shared_ptr<HuffmanNode>, HuffmanLowerFrequencyFirst>;
...
inline std::unordered_map<char, std::string>
huffmanGenerateCodesLeftHeap(const std::vector<HuffmanSymbol> &alphabet) {
  using PQType =
      PQ_LeftHeap<std::shared_ptr<HuffmanNode>, HuffmanLowerFrequencyFirst>;
  return huffmanGenerateCodesWith<PQType>(alphabet);
}
...
inline std::string
huffmanEncode(const std::string &text,
...
inline std::string huffmanDecode(const std::string &bits,
  ...
  for (char bit : bits) {
    if (bit == '0') {
      ...
      throw std::invalid_argument(
          "La cadena codificada solo puede contener 0 y 1");
    }
    if (!u) {
  ...
  if (u != root) {
    throw std::invalid_argument(
        "La cadena codificada termina a mitad de un codigo");
  }
  return out;
}

inline bool
huffmanIsPrefixFree(const std::unordered_map<char, std::string> &codes) {
...
inline int
huffmanWeightedPathLength(const std::vector<HuffmanSymbol> &alphabet,
                          const std::unordered_map<char, std::string> &codes) {
  int total = 0;
  for (const auto &s : alphabet) {
